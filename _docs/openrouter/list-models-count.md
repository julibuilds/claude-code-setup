      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/Models_listModelsCount_Response_200'
components:
  schemas:
    ModelsCountGetResponsesContentApplicationJsonSchemaData:
      type: object
      properties:
        count:
          type: number
      ...
      required:
        - count
    Models_listModelsCount_Response_200:
      type: object
      properties:
        data:
          $ref: >-
            #/components/schemas/ModelsCountGetResponsesContentApplicationJsonSchemaData
      required:
        - data
